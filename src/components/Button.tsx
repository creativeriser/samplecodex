...
export function Button({
  ...
  const baseStyles = 'inline-flex items-center justify-center gap-2 rounded-[var(--radius-lg)] border font-semibold tracking-tight leading-snug transition-colors duration-150 ease-out shadow focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/45 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-60 disabled:pointer-events-none disabled:shadow-none disabled:focus-visible:ring-0';

  const variants = {
    primary: 'bg-primary-600 text-white border-transparent shadow-md hover:bg-primary-500 hover:shadow-lg active:bg-primary-700 active:shadow-md focus-visible:ring-primary-500/30 disabled:bg-primary-400 disabled:text-white/85 disabled:hover:bg-primary-400 disabled:active:bg-primary-400 disabled:shadow-none',
